module.export = textArray = [
	'Pergunta importante: hamburger, dogão ou pizza?',
	'Aposto que sua risada é tão vibrante quanto seu sorriso. Verdade? Posso ouvi-lo algum dia? ',
	'Procurando recomendações: qual é a sua música favorita para quando você está limpando a casa?',
	'Eu amo estilo como o seu! Você sempre teve ele assim? ',
	...
	'Você já aprendeu alguma lição de vida com uma música?Qual?',
